...
5. Select install project dependencies, and use requirements.txt as your depedencies. (If there are any problems with dependencies when executing later, restart VSCode, if that doesn't work delete Python everywhere on your computer, delete .venv, reinstall it and start these instructions again).
